...
architecture matrix_multiplier_arch of mat_mult_v2 is
    ...
    type state_type is (IDLE, READ_AB, COMPUTE, GOTO_NEXT_EL, WRITE_C1, WRITE_C2, WRITE_C3, COMPLETE);
    ...
    begin
        if rst = '1' then
            ...
            case state is
                ...
                when WRITE_C1 =>
                    write_enable_out <= '1';
                    output_address <= std_logic_vector(to_unsigned(k, output_address'length));
                    output_matrix_value <= temp_ram(k);
                    state <= WRITE_C2;
