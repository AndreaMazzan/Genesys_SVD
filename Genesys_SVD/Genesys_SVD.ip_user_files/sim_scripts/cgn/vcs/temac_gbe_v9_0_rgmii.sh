...
#
# Script generated by Vivado on Tue Feb 06 12:06:57 AEDT 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : temac_gbe_v9_0_rgmii.sh
...
#
# Usage        : temac_gbe_v9_0_rgmii.sh
#                temac_gbe_v9_0_rgmii.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                temac_gbe_v9_0_rgmii.sh [-reset_run]
#                temac_gbe_v9_0_rgmii.sh [-reset_log]
#                temac_gbe_v9_0_rgmii.sh [-help]
#
...
#                script (type 'temac_gbe_v9_0_rgmii.sh -help' for more information).
#
...
# script info
echo -e "temac_gbe_v9_0_rgmii.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./temac_gbe_v9_0_rgmii.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.temac_gbe_v9_0_rgmii xil_defaultlib.glbl -o temac_gbe_v9_0_rgmii_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./temac_gbe_v9_0_rgmii_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/andrea/Documents/gitHub/fpga-comm/FPGA_comm/2023-firmware-fpga-comm/test_andrea/genesys2/genesys2.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key temac_gbe_v9_0_rgmii_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc temac_gbe_v9_0_rgmii_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./temac_gbe_v9_0_rgmii.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: temac_gbe_v9_0_rgmii.sh [-help]\n\
Usage: temac_gbe_v9_0_rgmii.sh [-step]\n\
Usage: temac_gbe_v9_0_rgmii.sh [-lib_map_path]\n\
Usage: temac_gbe_v9_0_rgmii.sh [-reset_run]\n\
Usage: temac_gbe_v9_0_rgmii.sh [-reset_log]\n\
Usage: temac_gbe_v9_0_rgmii.sh [-keep_index]\n\
Usage: temac_gbe_v9_0_rgmii.sh [-noclean_files]\n\n\
