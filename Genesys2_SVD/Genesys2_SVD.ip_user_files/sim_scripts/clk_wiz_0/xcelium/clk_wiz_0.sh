...
#
# Script generated by Vivado on Fri Aug 08 16:13:35 AEST 2025
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/FPGA_projects/Genesys2_SVD/Genesys2_SVD/Genesys2_SVD.cache/compile_simlib/xcelium"
  fi
