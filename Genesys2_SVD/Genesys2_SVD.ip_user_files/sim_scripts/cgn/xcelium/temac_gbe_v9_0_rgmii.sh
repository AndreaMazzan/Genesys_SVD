...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.temac_gbe_v9_0_rgmii xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.temac_gbe_v9_0_rgmii -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/andrea/Documents/gitHub/fpga-comm/FPGA_comm/2023-firmware-fpga-comm/test_andrea/genesys2/genesys2.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log temac_gbe_v9_0_rgmii_sc.so .tmp_log xcelium_lib waves.shm c.obj)
